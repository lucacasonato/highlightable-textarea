...
function I(n2) {
  if (n2.__P && n2.__d) {
    ...
    o3.__v = u4.__v + 1, l.vnode && l.vnode(o3), q(n2.__P, o3, u4, n2.__n, n2.__P.namespaceURI, 32 & u4.__u ? [
      t3
    ] : null, i4, null == t3 ? $(u4) : t3, !!(32 & u4.__u), r3), o3.__v = u4.__v, o3.__.__k[o3.__i] = o3, D(i4, o3, r3), u4.__e = u4.__ = null, o3.__e != t3 && P(o3);
  }
}
function P(n2) {
...
function T(n2, l3, u4, t3, i4) {
  ...
  for (n2.__k = new Array(i4), r3 = 0; r3 < i4; r3++) null != (o3 = l3[r3]) && "boolean" != typeof o3 && "function" != typeof o3 ? ("string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? o3 = n2.__k[r3] = x(null, o3, null, null, null) : g(o3) ? o3 = n2.__k[r3] = x(S, {
    children: o3
  }, null, null, null) : void 0 === o3.constructor && o3.__b > 0 ? o3 = n2.__k[r3] = x(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : n2.__k[r3] = o3, f4 = r3 + h3, o3.__ = n2, o3.__b = n2.__b + 1, e3 = null, -1 != (c3 = o3.__i = O(o3, u4, f4, a3)) && (a3--, (e3 = u4[c3]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c3 && (i4 > s3 ? h3-- : i4 < s3 && h3++), "function" != typeof o3.type && (o3.__u |= 4)) : c3 != f4 && (c3 == f4 - 1 ? h3-- : c3 == f4 + 1 ? h3++ : (c3 > f4 ? h3-- : h3++, o3.__u |= 4))) : n2.__k[r3] = null;
...
function q(n2, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  ...
  n: if ("function" == typeof T3) try {
    ...
    h3.state = h3.__s, null != h3.getChildContext && (i4 = m(m({}, i4), h3.getChildContext())), x2 && !p3 && null != h3.getSnapshotBeforeUpdate && (d3 = h3.getSnapshotBeforeUpdate(v3, y3)), A3 = null != a3 && a3.type === S && null == a3.key ? E(a3.props.children) : a3, f4 = L(n2, g(A3) ? A3 : [
      A3
    ], u4, t3, i4, r3, o3, e3, f4, c3, s3), h3.base = u4.__e, u4.__u &= -161, h3.__h.length && e3.push(h3), _2 && (h3.__E = h3.__ = null);
  } catch (n3) {
...
function G(u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  ...
  if (null == x2) m3 === k3 || c3 && u4.data == k3 || (u4.data = k3);
    ...
    if (h3) c3 || p3 && (h3.__html == p3.__html || h3.__html == u4.innerHTML) || (u4.innerHTML = h3.__html), t3.__k = [];
      ...
      v3
    ], t3, i4, r3, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o3, e3, f4, e3 ? e3[0] : i4.__k && $(i4, 0), c3, s3), null != e3) for (a3 = e3.length; a3--; ) b(e3[a3]);
...
function R(u4, t3, i4) {
  var r3, o3, e3, f4;
  t3 == document && (t3 = document.documentElement), l.__ && l.__(u4, t3), o3 = (r3 = "function" == typeof i4) ? null : i4 && i4.__k || t3.__k, e3 = [], f4 = [], q(t3, u4 = (!r3 && i4 || t3).__k = k(S, null, [
    u4
  ]), o3 || d, d, t3.namespaceURI, !r3 && i4 ? [
    i4
  ] : o3 ? null : t3.firstChild ? n.call(t3.childNodes) : null, e3, !r3 && i4 ? i4 : o3 ? o3.__e : t3.firstChild, r3, f4), D(e3, u4, f4);
}
n = w.slice, l = {
...
// deno:https://jsr.io/@nic/local-highlight-registry/0.1.0/main.ts
var LocalHighlightRegistry = class {
   ...
   */
  add(name, range, priority = 0) {
    let set = this.#ranges.get(name);
    if (set == null) {
      this.#ranges.set(name, set = /* @__PURE__ */ new Set());
    ...
    if (globalHighlight == null) {
      ...
      if (globalHighlight.has(range)) {
        throw new Error("This range has been already registered as an highlight elsewhere.");
      }
      if (globalHighlight.priority !== priority) {
        console.warn(`The label ${name} has already been registered elsewhere with priority ${globalHighlight.priority}, but is being used with priority ${priority} here.`);
      }
    }
    set.add(range);
  ...
  deleteAll(name) {
    ...
    if (warn) {
      console.warn(`One or more ${name} ranges owned by this LocalHighlightRegistry have already been deleted elsewhere.`);
    }
...
function* locationizeTokens(div, tokens) {
  ...
  let offset = 0;
  let lastIndex = 0;
  const advance = (index, preferStart) => {
    if (index < lastIndex) {
      node = div.firstChild;
      offset = 0;
      lastIndex = 0;
    ...
    let remaining;
    while (remaining = node.textContent.length - offset, preferStart && node.nextSibling ? remaining <= delta : remaining < delta) {
      delta -= remaining;
  ...
  for (const token of tokens) {
    ...
    if (start === end) {
      const error = new Error("Zero-length token", {
        cause: token
      });
